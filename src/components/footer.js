    ...
    return (
        <div className='d-flex flex-column align-items-center p-5 justify-content-center'>
            <div className='fs-2 m-2 d-flex social-icons justify-content-between' >
                <a href='https://github.com/jovsz' ><i class="fab fa-github tobig"></i></a>
                <a href='https://github.com/jovsz' ><i class="fab fa-linkedin tobig"></i></a>
                <a href='https://github.com/jovsz' ><i class="fab fa-telegram tobig"></i></a>
            </div>
